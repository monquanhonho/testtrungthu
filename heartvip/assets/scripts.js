...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
      messages: ["chúc em trung thu vui vẻ ", "yeuu emmmmm " ," vuiii vẻ nheeeee"],
      images: [],
      heartColor: "#ffffcc",
    },
  };
...
starLayers["forEach"]((t) => {
  scene["add"](t);
  t.visible = !window.__HEARTVIP_NO_STARS__;
  fadeObjects["push"](t);
...
cosmicDust.visible = !window.__HEARTVIP_NO_STARS__;
...
window.revealHeart = triggerSceneActivation;
const img = new Image();
img.src =
...
if (!window.__HEARTVIP_MANUAL_START__) {
